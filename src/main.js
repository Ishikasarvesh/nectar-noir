...
/* ========================================
   EXTRACTION CHAIN ANIMATIONS
======================================== */

const extractionStages = gsap.utils.toArray(
  ".extraction-stage"
);

gsap.from(".extraction-heading-meta span", {
  scrollTrigger: {
    trigger: ".extraction-heading",
    start: "top 75%",
  },
  y: 20,
  opacity: 0,
...
gsap.from(".extraction-heading h2", {
  scrollTrigger: {
    trigger: ".extraction-heading",
    start: "top 65%",
  },
...
gsap.from(".extraction-heading > p", {
  scrollTrigger: {
    trigger: ".extraction-heading",
    start: "top 55%",
  },
...
extractionStages.forEach((stage, index) => {
  ...
  gsap.from(stage.querySelector(".extraction-stage-visual"), {
    scrollTrigger: {
      trigger: stage,
      start: "top 70%",
    },
  ...
  gsap.from(stage.querySelector(".extraction-stage-content"), {
    scrollTrigger: {
      trigger: stage,
      start: "top 66%",
    },
  ...
  const pipeFill = stage.querySelector(".pipeline span");
  ...
  ScrollTrigger.create({
    ...
    onEnter: () => {
      updateExtractionStage(stage, index, number);
    },
...
function updateExtractionStage(stage, index, number) {
  extractionStages.forEach((item) => {
  ...
  document.querySelector(
    ".extraction-current-stage"
  ).textContent = number;

  const progress =
    ((index + 1) / extractionStages.length) * 100;

  gsap.to(".extraction-progress-fill", {
    width: `${progress}%`,
    duration: 0.55,
    ease: "power3.out",
  });
...
/* Rotating extraction machine */

gsap.to(".extractor-ring-one", {
  rotation: 360,
  duration: 11,
  repeat: -1,
  ease: "none",
...
/* Fill the final vessel while scrolling */

gsap.to(".vessel-honey", {
  height: "78%",
  scrollTrigger: {
    trigger: ".extraction-stage-final",
    start: "top 70%",
    end: "center center",
    scrub: 1.2,
  },
