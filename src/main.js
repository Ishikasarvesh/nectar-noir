...
<section class="dealer-section" id="dealer">
...
const dealerPaper = document.querySelector(
  ".dealer-paper"
);
...
/* Entire old page rises from below */
...
/* Content appears after the paper rises */

gsap.from(
  ".dealer-introduction > *, .dealer-record, .dealer-contact-column > *",
  {
    opacity: 0,
    y: 14,
    stagger: 0.055,
...
/* Very small photocopy flicker on entry */
